...
import io.tiago.utils.Constants;
import io.tiago.utils.FileUtil;
...
public class Cryptographer {
    ...
    public Vault init() throws Exception {
        ...
        FileUtil.write(Constants.VECTOR_FILE, encodedIV);
        FileUtil.write(Constants.SECRET_KEY_FILE, encodedKey);
        FileUtil.write(Constants.SALT_FILE, encodedSalt);
    ...
    private SecretKeySpec getScretKey() throws Exception {
        final String SECRET = new String(FileUtil.readKeyFile());
        final String SALT = new String(FileUtil.readSaltKeyFile());
